...
# from .redirect import Choicess,QuestionSurvey,Surveyy
from .category import Category
from .survey import Survey
# from .redirect import Choicess
try:  # pragma: no cover
...
class Question(models.Model):
    ...
    # choicess = models.ManyToManyField(choicess, verbose_name=_("Choicess"), blank=True)  # Changed to ManyToManyField with Choice model
