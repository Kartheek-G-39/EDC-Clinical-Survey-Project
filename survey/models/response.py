...
from .survey import Survey, Participant, Protocol
...
class Response(models.Model):
    ...
    participant = models.ForeignKey(Participant, on_delete=models.SET_NULL, null=True, blank=True, related_name='responses')
    protocol = models.ForeignKey(Protocol, on_delete=models.SET_NULL, null=True, blank=True, related_name='responses')


    # user = models.ForeignKey('auth.User', on_delete=models.SET_NULL, null=True, blank=True)
    # survey = models.ForeignKey('survey.Survey', on_delete=models.CASCADE, related_name='responses')
    #
    ...
    def __str__(self):
        msg = f"Response to {self.survey} by {self.participant}"
